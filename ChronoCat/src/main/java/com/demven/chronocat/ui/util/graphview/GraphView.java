package com.demven.chronocat.ui.util.graphview;
...
import com.demven.chronocat.ui.util.graphview.GraphViewSeries.GraphViewSeriesStyle;
import com.demven.chronocat.ui.util.graphview.compatible.ScaleGestureDetector;

/**
 * GraphView is a Android View for creating zoomable and scrollable graphs.
 * This is the abstract base class for all graphs. Extend this class and implement {@link ( android.graphics.Canvas, GraphViewDataInterface[], float, float, float, double, double, double, double, float)} to display a custom graph.
