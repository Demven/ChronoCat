package com.demven.chronocat.ui.util.graphview.compatible;
...
public class ScaleGestureDetector {
    ...
    public ScaleGestureDetector(Context context, SimpleOnScaleGestureListener simpleOnScaleGestureListener) {
        try {
            ...
            Class<?> classRealScaleGestureDetector = Class.forName("com.demven.chronocat.ui.util.graphview.compatible.RealScaleGestureDetector");
            ...
            // not available
            Log.w("com.demven.chronocat.ui.util.graphview", "*** WARNING *** No scaling available for graphs. Exception:");
            e.printStackTrace();
        }
    }
